...
select lives_ok($$select public.crm_create_student_with_guardians('93000000-0000-4000-8000-000000000010',jsonb_build_object('full_name','Acceptance child','status','prospect','lesson_price',700),jsonb_build_array(jsonb_build_object('guardian_id','93000000-0000-4000-8000-000000000020','relation','Родитель','is_primary',true,'is_billing_contact',true)),null)$$,'child is created and linked later without a group');
