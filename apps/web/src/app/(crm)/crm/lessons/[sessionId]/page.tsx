...
export default function LessonConductPage() {
  ...
  return (
    <div style={{ display: "grid", gap: 22 }}>
      ...
      <LessonConductPanel data={data} rows={rows} readOnly={session.status === "completed"} trialReadOnly={false} onRowsChange={setRows} onSaveAttendance={saveAttendance} onComplete={completeSession} onAssignHomework={data.canAssignHomework ? assignHomework : undefined} saving={saving} completing={completing} message={message} />
      {modal}
    </div>
  );
}
