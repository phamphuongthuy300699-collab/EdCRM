...
export default function TeacherPage() {
  ...
  const loadSessions = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/crm/schedule?dateFrom=${today}&dateTo=${today}${previewQuery}`);
  ...
  }, [demo, previewReady, previewTeacherId]);
